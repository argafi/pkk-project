    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggled" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center mt-2" href="index.html">
                <div class="sidebar-brand-icon d-flex flex-column justify-content-center align-items-center mt-0">
                    <img src="<?= BASE_URL ?>/img/good-guide-logo.svg" alt="" />
                </div>
            </a>
            ...
            <!-- Heading -->
            <div class="sidebar-heading mb-2">Menu</div>
